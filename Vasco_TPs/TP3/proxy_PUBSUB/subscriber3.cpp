...
int main() {
    ...
    // Subscribe to topic_3
    subscriber.set(zmq::sockopt::subscribe, "topic_3");

    std::cout << "Subscriber 3 started, listening to topic_3\n";
    ...
    while (true) {
        ...
        std::cout << "Subscriber 3 received [" << topic_str << "]: " << message_str << std::endl;
    }
