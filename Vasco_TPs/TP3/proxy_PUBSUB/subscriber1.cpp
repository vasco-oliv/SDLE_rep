...
int main() {
    ...
    // Subscribe to topic_1
    subscriber.set(zmq::sockopt::subscribe, "topic_1");

    std::cout << "Subscriber 1 started, listening to topic_1\n";
    ...
    while (true) {
        ...
        std::cout << "Subscriber 1 received [" << topic_str << "]: " << message_str << std::endl;
    }
